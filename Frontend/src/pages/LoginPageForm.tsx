...
const Login: React.FC<Props> = ({ switchToForgotPassword, messageApi }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className="text-sm text-blue-600 hover:cursor-pointer mb-4 transition-colors duration-200 hover:text-blue-500"
