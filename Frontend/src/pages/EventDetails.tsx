          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center text-slate-600 mb-4">
                ...
                <span className="text-lg font-medium">{event.organization}</span>
              </div>
            </div>
            ...
            {event.requirements && (
              <Card className="p-6 bg-white border-0 shadow-lg">
                <h2 className="text-xl font-semibold text-slate-800 mb-4">Requirements</h2>
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-700 leading-7 whitespace-pre-line">
                    {event.requirements}
                  </p>
              ...
              <div className="space-y-4">
                ...
                {event.location && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      {event.isOnline && (
                        <div className="text-sm text-blue-600">Online Event</div>
                      )}
                    </div>
                  </div>
                )}
                ...
                {event.isOnline && event.meetingLink && (
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="font-medium text-slate-800">Meeting Link</div>
                      <a 
                ...
                {event.capacity && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">{event.capacity} attendees</div>
                    </div>
                  </div>
                )}
                ...
                {event.registrationDeadline && (
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="font-medium text-slate-800">Registration Deadline</div>
                      <div className="text-sm text-slate-600">{formatDate(event.registrationDeadline)}</div>
                    </div>
                  </div>
                )}
              </div>
