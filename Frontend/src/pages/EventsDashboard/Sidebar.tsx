      ...
      <div className="w-52 lg:w-64 fixed flex min-h-screen flex-col bg-white/80 backdrop-blur-md p-4 text-white text-sm">
        ...
        <div className="flex items-center space-x-3 p-2">
          ...
          <div>
            ...
            <h6 className="text-xs text-gray-700">Manager Account</h6>
          </div>
        </div>
        ...
        <ul className="mt-6 grow list-none text-black">
          ...
          <Link to="/">
            <li className="mb-1 flex cursor-pointer items-center space-x-3 rounded-lg p-2 hover:bg-[#E5E5E5]">
              {home}
              <p>&nbsp;Home</p>
            </li>
          </Link>
          ...
          <Link to="/manager/my-events">
            <li
              className={`mb-1 flex cursor-pointer items-center space-x-3 rounded-lg p-2 ${
                location.pathname.toLowerCase() === "/manager/my-events"
          ...
          <Link to="/manager/create-events">
            <li
              className={`mb-1 flex cursor-pointer items-center space-x-3 rounded-lg p-2 ${
                location.pathname.toLowerCase() === "/manager/create-events"
                  ? "bg-blue-600 text-white"
                  : "hover:bg-[#E5E5E5]"
              }`}
            >
          ...
          <Link to="/manager/settings">
            <li
              className={`mb-1 flex cursor-pointer items-center space-x-3 rounded-lg p-2 ${
                location.pathname.toLowerCase() === "/manager/settings"
                  ? "bg-blue-600 text-white"
                  : "hover:bg-[#E5E5E5]"
              }`}
            >
