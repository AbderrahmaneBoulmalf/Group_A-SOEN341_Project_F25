...
const CreateEvents: React.FC = () => {
  ...
  const [managerStatus, setManagerStatus] = useState<number | null>(null);
  ...
  const requiredFields = useMemo<readonly (keyof EventFormData)[]>(
    () => ["title", "date", "organization", "description", "location", "category", "contactEmail"],
    []
  );
  ...
  const validateForm = () => {
    ...
    if (formData.registrationDeadline && formData.date && formData.registrationDeadline > formData.date) {
      validationErrors.registrationDeadline = "Deadline cannot be after the event date.";
    }
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const payload = {
        ...
        meetingLink: formData.isOnline ? formData.meetingLink.trim() || null : null,
      };
          ...
          <fieldset disabled={isBlocked}>
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  <label htmlFor="organization" className="mb-2 block text-sm font-medium text-slate-600">
                    Organization *
                  </label>
                  <input
                    id="organization"
              ...
              <div>
                <label htmlFor="longDescription" className="mb-2 block text-sm font-medium text-slate-600">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="date" className="mb-2 block text-sm font-medium text-slate-600">
                    Event Date *
                  </label>
                  <input
                    id="date"
                ...
                <div>
                  <label htmlFor="registrationDeadline" className="mb-2 block text-sm font-medium text-slate-600">
                  ...
                  {errors.registrationDeadline && (
                    <p className="mt-1 text-xs text-red-500">{errors.registrationDeadline}</p>
                  )}
                </div>
              </div>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="startTime" className="mb-2 block text-sm font-medium text-slate-600">
                    Start Time
                  </label>
                  <input
                    id="startTime"
                ...
                <div>
                  <label htmlFor="endTime" className="mb-2 block text-sm font-medium text-slate-600">
                    End Time
                  </label>
                  <input
                    id="endTime"
            ...
            <section className="space-y-6">
              <h2 className="text-lg font-medium text-slate-800">Attendance & Logistics</h2>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                ...
                <div className="flex items-center gap-3 pt-6">
                  ...
                  />
                  <label htmlFor="isOnline" className="text-sm font-medium text-slate-600">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="capacity" className="mb-2 block text-sm font-medium text-slate-600">
                    Capacity
                  </label>
                  <input
                    id="capacity"
              ...
              <div>
                <label htmlFor="meetingLink" className="mb-2 block text-sm font-medium text-slate-600">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`${inputStyles} ${!formData.isOnline ? "bg-slate-100" : ""}`}
                  placeholder="https://..."
              ...
              <div>
                <label htmlFor="requirements" className="mb-2 block text-sm font-medium text-slate-600">
                  Requirements
                </label>
                <textarea
                  id="requirements"
            ...
            <section className="space-y-6">
              <h2 className="text-lg font-medium text-slate-800">Media & Contact</h2>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="imageUrl" className="mb-2 block text-sm font-medium text-slate-600">
                    Image URL
                  </label>
                  <input
                    id="imageUrl"
                ...
                <div>
                  <label htmlFor="contactPhone" className="mb-2 block text-sm font-medium text-slate-600">
                    Contact Phone
                  </label>
                  <input
                    id="contactPhone"
              ...
              <div>
                <label htmlFor="contactEmail" className="mb-2 block text-sm font-medium text-slate-600">
                  Contact Email *
                </label>
                <input
                  id="contactEmail"
